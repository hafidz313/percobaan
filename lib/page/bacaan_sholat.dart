import 'dart:convert';
import 'package:percobaan/model/model_bacaan.dart';
...
class _BacaanSholatState extends State<BacaanSholat> {
  Future<List<ModelBacaan>> ReadJsonData() async {
    final jsondata =
        await rootBundle.rootBundle.loadString('assets/data/terjemahan.json');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 4, 188, 161),
      body: SafeArea(
        child: Column(
